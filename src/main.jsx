...
import { Newsletter, RetentionPanel } from './components/Retention.jsx';
...
import {
  ...
  marketplaceProducts,
  publisherDirectory,
} from './constants/intelligence.js';
import {
  categories,
  categoryRoutes,
  intelligenceCountries,
...
import {
  ...
  normalizeCountry,
  placeLabel,
  readRecentLocalLocations,
  rememberLocalLocation,
  uniquePlacePairs,
...
const translations = {
  ...
  fr: {
    tagline: 'Pont mondial des actualités IA',
    searchPlaceholder: 'Rechercher les actualités...',
    search: 'Rechercher',
    newsLanguage: 'Langue des actualités',
    home: 'Accueil',
    logout: 'Déconnexion',
    breaking: 'URGENT',
    localNewsFor: 'Actualités locales pour',
    useLocation: 'Utiliser ma position',
    latestStories: 'Dernières actualités',
    aiBriefReady: 'Résumé IA prêt',
    readStory: 'Lire',
    aiBrief: 'Résumé IA',
    save: 'Enregistrer',
    source: 'Source',
    ...
    emptyFeed: "Aucune actualité en direct pour l'instant.",
    categories: { local: 'Local', top: 'À la une', world: 'Monde', business: 'Économie', tech: 'Technologie', ai: 'IA', sports: 'Sport', entertainment: 'Culture', health: 'Santé', science: 'Science', live: 'Direct', video: 'Vidéo' },
  },
  de: {
    tagline: 'Globale KI-Nachrichtenbrücke',
    searchPlaceholder: 'Nachrichten suchen...',
    search: 'Suchen',
    newsLanguage: 'Nachrichtensprache',
    home: 'Start',
    logout: 'Abmelden',
    breaking: 'EILMELDUNG',
    localNewsFor: 'Lokale Nachrichten für',
    useLocation: 'Standort verwenden',
    latestStories: 'Aktuelle Meldungen',
    aiBriefReady: 'KI-Kurzfassung bereit',
    readStory: 'Lesen',
    aiBrief: 'KI-Briefing',
    save: 'Speichern',
    source: 'Quelle',
    trending: 'Im Trend',
    readOriginal: 'Original beim Publisher lesen',
    emptyFeed: 'Noch keine Live-Nachrichten geladen.',
    categories: { local: 'Lokal', top: 'Top-News', world: 'Welt', business: 'Wirtschaft', tech: 'Technologie', ai: 'KI', sports: 'Sport', entertainment: 'Unterhaltung', health: 'Gesundheit', science: 'Wissenschaft', live: 'Live-News', video: 'Video' },
  },
  pt: {
    tagline: 'Ponte global de noticias com IA',
    searchPlaceholder: 'Pesquisar noticias...',
    search: 'Pesquisar',
    newsLanguage: 'Idioma das noticias',
    home: 'Inicio',
    logout: 'Sair',
    breaking: 'URGENTE',
    localNewsFor: 'Noticias locais para',
    useLocation: 'Usar minha localizacao',
    latestStories: 'Ultimas noticias',
    aiBriefReady: 'Resumo IA pronto',
    readStory: 'Ler noticia',
    aiBrief: 'Resumo IA',
    save: 'Salvar',
    source: 'Fonte',
    trending: 'Tendencias',
    readOriginal: 'Ler no publicador original',
    emptyFeed: 'Nenhuma noticia ao vivo carregada ainda.',
    categories: { local: 'Local', top: 'Principais', world: 'Mundo', business: 'Negocios', tech: 'Tecnologia', ai: 'IA', sports: 'Esportes', entertainment: 'Entretenimento', health: 'Saude', science: 'Ciencia', live: 'Ao vivo', video: 'Video' },
  },
  ru: {
    tagline: 'Глобальный новостной мост с ИИ',
    ...
    logout: 'Выйти',
    breaking: 'СРОЧНО',
    localNewsFor: 'Местные новости для',
    useLocation: 'Использовать мое местоположение',
    latestStories: 'Последние новости',
    aiBriefReady: 'ИИ-сводка готова',
    readStory: 'Читать',
    aiBrief: 'ИИ-сводка',
    save: 'Сохранить',
    source: 'Источник',
    trending: 'В тренде',
    readOriginal: 'Читать у исходного издателя',
    emptyFeed: 'Пока нет загруженных live-новостей.',
    categories: { local: 'Местные', top: 'Главные', world: 'Мир', business: 'Бизнес', tech: 'Технологии', ai: 'ИИ', sports: 'Спорт', entertainment: 'Развлечения', health: 'Здоровье', science: 'Наука', live: 'Прямой эфир', video: 'Видео' },
  },
  bn: {
    tagline: 'AI বৈশ্বিক সংবাদ সেতু',
    ...
    logout: 'লগআউট',
    breaking: 'ব্রেকিং',
    localNewsFor: 'স্থানীয় সংবাদ',
    useLocation: 'আমার অবস্থান ব্যবহার করুন',
    latestStories: 'সর্বশেষ সংবাদ',
    aiBriefReady: 'AI সারাংশ প্রস্তুত',
    readStory: 'পড়ুন',
    aiBrief: 'AI সারাংশ',
    save: 'সেভ',
    source: 'সূত্র',
    trending: 'ট্রেন্ডিং',
    readOriginal: 'মূল প্রকাশকের খবর পড়ুন',
    emptyFeed: 'এখনও লাইভ সংবাদ লোড হয়নি।',
    categories: { local: 'স্থানীয়', top: 'শীর্ষ খবর', world: 'বিশ্ব', business: 'ব্যবসা', tech: 'প্রযুক্তি', ai: 'AI', sports: 'খেলা', entertainment: 'বিনোদন', health: 'স্বাস্থ্য', science: 'বিজ্ঞান', live: 'লাইভ নিউজ', video: 'ভিডিও' },
  },
  ta: {
    tagline: 'AI உலக செய்தி பாலம்',
    ...
    logout: 'வெளியேறு',
    breaking: 'பிரேக்கிங்',
    localNewsFor: 'உள்ளூர் செய்திகள்',
    useLocation: 'என் இருப்பிடத்தை பயன்படுத்து',
    latestStories: 'சமீபத்திய செய்திகள்',
    aiBriefReady: 'AI சுருக்கம் தயார்',
    readStory: 'படிக்க',
    aiBrief: 'AI சுருக்கம்',
    save: 'சேமி',
    source: 'மூலம்',
    trending: 'டிரெண்டிங்',
    readOriginal: 'மூல வெளியீட்டாளர் செய்தியைப் படிக்க',
    emptyFeed: 'இன்னும் நேரடி செய்திகள் இல்லை.',
    categories: { local: 'உள்ளூர்', top: 'முக்கிய செய்திகள்', world: 'உலகம்', business: 'வணிகம்', tech: 'தொழில்நுட்பம்', ai: 'AI', sports: 'விளையாட்டு', entertainment: 'பொழுதுபோக்கு', health: 'ஆரோக்கியம்', science: 'அறிவியல்', live: 'நேரலை செய்திகள்', video: 'வீடியோ' },
  },
  te: {
    tagline: 'AI గ్లోబల్ న్యూస్ బ్రిడ్జ్',
    ...
    logout: 'లాగౌట్',
    breaking: 'బ్రేకింగ్',
    localNewsFor: 'స్థానిక వార్తలు',
    useLocation: 'నా స్థానాన్ని వాడండి',
    latestStories: 'తాజా వార్తలు',
    aiBriefReady: 'AI సారాంశం సిద్ధం',
    readStory: 'చదవండి',
    aiBrief: 'AI సారాంశం',
    save: 'సేవ్',
    source: 'మూలం',
    trending: 'ట్రెండింగ్',
    readOriginal: 'అసలు ప్రచురణకర్త కథ చదవండి',
    emptyFeed: 'ఇంకా లైవ్ వార్తలు లోడ్ కాలేదు.',
    categories: { local: 'స్థానికం', top: 'టాప్ న్యూస్', world: 'ప్రపంచం', business: 'బిజినెస్', tech: 'టెక్నాలజీ', ai: 'AI', sports: 'క్రీడలు', entertainment: 'వినోదం', health: 'ఆరోగ్యం', science: 'సైన్స్', live: 'లైవ్ న్యూస్', video: 'వీడియో' },
  },
  mr: {
    tagline: 'AI जागतिक बातमी पूल',
    ...
    logout: 'लॉगआउट',
    breaking: 'ब्रेकिंग',
    localNewsFor: 'स्थानिक बातम्या',
    useLocation: 'माझे लोकेशन वापरा',
    latestStories: 'ताज्या बातम्या',
    aiBriefReady: 'AI सारांश तयार',
    readStory: 'वाचा',
    aiBrief: 'AI सारांश',
    save: 'सेव्ह',
    source: 'स्रोत',
    trending: 'ट्रेंडिंग',
    readOriginal: 'मूळ प्रकाशकाची बातमी वाचा',
    emptyFeed: 'अजून लाइव्ह बातम्या लोड झालेल्या नाहीत.',
    categories: { local: 'स्थानिक', top: 'टॉप न्यूज', world: 'जग', business: 'व्यवसाय', tech: 'तंत्रज्ञान', ai: 'AI', sports: 'क्रीडा', entertainment: 'मनोरंजन', health: 'आरोग्य', science: 'विज्ञान', live: 'लाइव्ह न्यूज', video: 'व्हिडिओ' },
  },
  gu: {
    tagline: 'AI વૈશ્વિક સમાચાર પુલ',
    searchPlaceholder: 'સમાચાર શોધો...',
    search: 'શોધો',
    newsLanguage: 'સમાચાર ભાષા',
    home: 'હોમ',
    logout: 'લોગઆઉટ',
    breaking: 'બ્રેકિંગ',
    localNewsFor: 'સ્થાનિક સમાચાર',
    useLocation: 'મારું સ્થાન વાપરો',
    latestStories: 'તાજા સમાચાર',
    aiBriefReady: 'AI સારાંશ તૈયાર',
    readStory: 'વાંચો',
    aiBrief: 'AI સારાંશ',
    save: 'સેવ',
    source: 'સ્ત્રોત',
    trending: 'ટ્રેન્ડિંગ',
    readOriginal: 'મૂળ પ્રકાશકની ખબર વાંચો',
    emptyFeed: 'હજુ લાઈવ સમાચાર લોડ થયા નથી.',
    categories: { local: 'સ્થાનિક', top: 'ટોપ ન્યૂઝ', world: 'વિશ્વ', business: 'બિઝનેસ', tech: 'ટેકનોલોજી', ai: 'AI', sports: 'રમતગમત', entertainment: 'મનોરંજન', health: 'આરોગ્ય', science: 'વિજ્ઞાન', live: 'લાઈવ ન્યૂઝ', video: 'વિડિયો' },
  },
  kn: {
    tagline: 'AI ಜಾಗತಿಕ ಸುದ್ದಿ ಸೇತುವೆ',
    searchPlaceholder: 'ಸುದ್ದಿ ಹುಡುಕಿ...',
    search: 'ಹುಡುಕಿ',
    newsLanguage: 'ಸುದ್ದಿ ಭಾಷೆ',
    home: 'ಮುಖಪುಟ',
    logout: 'ಲಾಗೌಟ್',
    breaking: 'ಬ್ರೇಕಿಂಗ್',
    localNewsFor: 'ಸ್ಥಳೀಯ ಸುದ್ದಿ',
    useLocation: 'ನನ್ನ ಸ್ಥಳ ಬಳಸಿ',
    latestStories: 'ಇತ್ತೀಚಿನ ಸುದ್ದಿ',
    aiBriefReady: 'AI ಸಾರಾಂಶ ಸಿದ್ಧ',
    readStory: 'ಓದಿ',
    aiBrief: 'AI ಸಾರಾಂಶ',
    save: 'ಸೇವ್',
    source: 'ಮೂಲ',
    trending: 'ಟ್ರೆಂಡಿಂಗ್',
    readOriginal: 'ಮೂಲ ಪ್ರಕಟಕರ ಸುದ್ದಿಯನ್ನು ಓದಿ',
    emptyFeed: 'ಇನ್ನೂ ಲೈವ್ ಸುದ್ದಿ ಲೋಡ್ ಆಗಿಲ್ಲ.',
    categories: { local: 'ಸ್ಥಳೀಯ', top: 'ಟಾಪ್ ನ್ಯೂಸ್', world: 'ವಿಶ್ವ', business: 'ವ್ಯಾಪಾರ', tech: 'ತಂತ್ರಜ್ಞಾನ', ai: 'AI', sports: 'ಕ್ರೀಡೆ', entertainment: 'ಮನರಂಜನೆ', health: 'ಆರೋಗ್ಯ', science: 'ವಿಜ್ಞಾನ', live: 'ಲೈವ್ ನ್ಯೂಸ್', video: 'ವೀಡಿಯೊ' },
  },
  ml: {
    tagline: 'AI ആഗോള വാർത്ത പാലം',
    searchPlaceholder: 'വാർത്തകൾ തിരയുക...',
    search: 'തിരയുക',
    newsLanguage: 'വാർത്ത ഭാഷ',
    home: 'ഹോം',
    logout: 'ലോഗൗട്ട്',
    breaking: 'ബ്രേക്കിംഗ്',
    localNewsFor: 'പ്രാദേശിക വാർത്തകൾ',
    useLocation: 'എന്റെ സ്ഥലം ഉപയോഗിക്കുക',
    latestStories: 'പുതിയ വാർത്തകൾ',
    aiBriefReady: 'AI സംഗ്രഹം തയ്യാറായി',
    readStory: 'വായിക്കുക',
    aiBrief: 'AI സംഗ്രഹം',
    save: 'സേവ്',
    source: 'ഉറവിടം',
    trending: 'ട്രെൻഡിംഗ്',
    readOriginal: 'മൂല പ്രസാധകന്റെ വാർത്ത വായിക്കുക',
    emptyFeed: 'ഇനിയും ലൈവ് വാർത്തകൾ ലോഡ് ചെയ്തിട്ടില്ല.',
    categories: { local: 'പ്രാദേശികം', top: 'പ്രധാന വാർത്തകൾ', world: 'ലോകം', business: 'ബിസിനസ്', tech: 'ടെക്നോളജി', ai: 'AI', sports: 'കായികം', entertainment: 'വിനോദം', health: 'ആരോഗ്യം', science: 'ശാസ്ത്രം', live: 'ലൈവ് ന്യൂസ്', video: 'വീഡിയോ' },
  },
  pa: {
    tagline: 'AI ਗਲੋਬਲ ਨਿਊਜ਼ ਪੁਲ',
    searchPlaceholder: 'ਖਬਰਾਂ ਲੱਭੋ...',
    search: 'ਲੱਭੋ',
    newsLanguage: 'ਖਬਰਾਂ ਦੀ ਭਾਸ਼ਾ',
    home: 'ਹੋਮ',
    logout: 'ਲਾਗਆਉਟ',
    breaking: 'ਬ੍ਰੇਕਿੰਗ',
    localNewsFor: 'ਸਥਾਨਕ ਖਬਰਾਂ',
    useLocation: 'ਮੇਰਾ ਟਿਕਾਣਾ ਵਰਤੋ',
    latestStories: 'ਤਾਜ਼ਾ ਖਬਰਾਂ',
    aiBriefReady: 'AI ਸੰਖੇਪ ਤਿਆਰ',
    readStory: 'ਪੜ੍ਹੋ',
    aiBrief: 'AI ਸੰਖੇਪ',
    save: 'ਸੇਵ',
    source: 'ਸਰੋਤ',
    trending: 'ਟ੍ਰੈਂਡਿੰਗ',
    readOriginal: 'ਮੂਲ ਪ੍ਰਕਾਸ਼ਕ ਦੀ ਖਬਰ ਪੜ੍ਹੋ',
    emptyFeed: 'ਹਾਲੇ ਕੋਈ ਲਾਈਵ ਖਬਰ ਲੋਡ ਨਹੀਂ ਹੋਈ।',
    categories: { local: 'ਸਥਾਨਕ', top: 'ਟਾਪ ਨਿਊਜ਼', world: 'ਦੁਨੀਆ', business: 'ਬਿਜ਼ਨਸ', tech: 'ਟੈਕਨਾਲੋਜੀ', ai: 'AI', sports: 'ਖੇਡਾਂ', entertainment: 'ਮਨੋਰੰਜਨ', health: 'ਸਿਹਤ', science: 'ਵਿਗਿਆਨ', live: 'ਲਾਈਵ ਨਿਊਜ਼', video: 'ਵੀਡੀਓ' },
  },
  ur: {
    tagline: 'AI عالمی نیوز پل',
    searchPlaceholder: 'خبریں تلاش کریں...',
    search: 'تلاش',
    newsLanguage: 'خبروں کی زبان',
    home: 'ہوم',
    logout: 'لاگ آؤٹ',
    breaking: 'بریکنگ',
    localNewsFor: 'مقامی خبریں',
    useLocation: 'میرا مقام استعمال کریں',
    latestStories: 'تازہ خبریں',
    aiBriefReady: 'AI خلاصہ تیار',
    readStory: 'پڑھیں',
    aiBrief: 'AI خلاصہ',
    save: 'محفوظ',
    source: 'ذریعہ',
    trending: 'ٹرینڈنگ',
    readOriginal: 'اصل ناشر کی خبر پڑھیں',
    emptyFeed: 'ابھی کوئی لائیو خبر لوڈ نہیں ہوئی۔',
    categories: { local: 'مقامی', top: 'اہم خبریں', world: 'دنیا', business: 'کاروبار', tech: 'ٹیکنالوجی', ai: 'AI', sports: 'کھیل', entertainment: 'تفریح', health: 'صحت', science: 'سائنس', live: 'لائیو نیوز', video: 'ویڈیو' },
  },
  zh: {
    tagline: 'AI 全球新闻桥',
    ...
    useLocation: '使用我的位置',
    latestStories: '最新新闻',
    aiBriefReady: 'AI 摘要已就绪',
    readStory: '阅读',
    aiBrief: 'AI 摘要',
    save: '保存',
    source: '来源',
    trending: '趋势',
    readOriginal: '阅读原始发布者报道',
    emptyFeed: '暂无实时新闻。',
    categories: { local: '本地', top: '头条', world: '世界', business: '商业', tech: '科技', ai: 'AI', sports: '体育', entertainment: '娱乐', health: '健康', science: '科学', live: '直播新闻', video: '视频' },
  },
  ja: {
    tagline: 'AIグローバルニュースブリッジ',
    ...
    logout: 'ログアウト',
    breaking: '速報',
    localNewsFor: 'ローカルニュース',
    useLocation: '現在地を使用',
    latestStories: '最新ニュース',
    aiBriefReady: 'AI要約準備完了',
    readStory: '読む',
    aiBrief: 'AI要約',
    save: '保存',
    source: '出典',
    trending: 'トレンド',
    readOriginal: '元の配信元で読む',
    emptyFeed: 'ライブニュースはまだありません。',
    categories: { local: 'ローカル', top: 'トップニュース', world: '世界', business: 'ビジネス', tech: 'テクノロジー', ai: 'AI', sports: 'スポーツ', entertainment: 'エンタメ', health: '健康', science: '科学', live: 'ライブニュース', video: '動画' },
  },
  ko: {
    tagline: 'AI 글로벌 뉴스 브리지',
    ...
    useLocation: '내 위치 사용',
    latestStories: '최신 뉴스',
    aiBriefReady: 'AI 요약 준비됨',
    readStory: '읽기',
    aiBrief: 'AI 요약',
    save: '저장',
    source: '출처',
    trending: '트렌딩',
    readOriginal: '원문 출처에서 읽기',
    emptyFeed: '아직 라이브 뉴스가 없습니다.',
    categories: { local: '지역', top: '주요 뉴스', world: '세계', business: '비즈니스', tech: '기술', ai: 'AI', sports: '스포츠', entertainment: '엔터테인먼트', health: '건강', science: '과학', live: '라이브 뉴스', video: '비디오' },
  },
};
