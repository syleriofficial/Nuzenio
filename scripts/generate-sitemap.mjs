...
const staticPages = [
  ['', 'hourly', '1.00'],
  ['about', 'monthly', '0.50'],
  ['sources', 'monthly', '0.50'],
  ['editorial-policy', 'monthly', '0.50'],
  ['fact-checking-policy', 'monthly', '0.50'],
  ['ai-policy', 'monthly', '0.50'],
  ['corrections', 'monthly', '0.50'],
  ['corrections-policy', 'monthly', '0.50'],
  ['contact', 'monthly', '0.50'],
  ['submit-source', 'monthly', '0.52'],
  ['publisher-dashboard', 'weekly', '0.50'],
  ['publisher-verify', 'monthly', '0.48'],
  ['advertise', 'monthly', '0.45'],
  ['newsletter', 'weekly', '0.58'],
  ['feeds', 'weekly', '0.55'],
  ['privacy', 'monthly', '0.40'],
  ['terms', 'monthly', '0.40'],
  ['affiliate-disclosure', 'monthly', '0.40'],
];
